...
/**
 * This class is the main class that is responsible for Reshaping Arabic
 * Sentences and Text Utilities Class to make it easier to deal with Arabic
 * Reshaper Class Wrapper for Arabic Reshaper Class
 * 
 * @author Amr Gawish
 */
public class ArabicUtilities {
	...
	public static boolean reshape(String allText, StringBuilder result) {
		boolean hasArabic = false;
		if (allText != null) {
			// StringBuffer result = new StringBuffer();
			String[] sentences = allText.split("\n");
			for (int i = 0; i < sentences.length; i++) {
				hasArabic = reshapeSentence(sentences[i], result) || hasArabic;
	 ...
	 */
	public static boolean reshapeSentence(String sentence,
			StringBuilder reshapedText) {
		// get the Words from the Text
		boolean startsWithArabic = false;
	...
	// public static TextView getArabicEnabledTextView(Context context, TextView
	// targetTextView) {
